...
export const supplierMetrics: SupplierMetric[] = [
  { key: 'assigned', label: 'RFQs ASIGNADAS', value: '5', valueColor: 'var(--bocar-blue-100)' },
  { key: 'pending', label: 'RFQs PENDIENTES', value: '2', valueColor: '#c8970a' },
  { key: 'quoted', label: 'RFQs COTIZADAS', value: '3', valueColor: '#5a8a1f' },
  { key: 'historical', label: 'RFQs HISTORICAS', value: '4', valueColor: 'var(--bocar-blue-50)' },
];
