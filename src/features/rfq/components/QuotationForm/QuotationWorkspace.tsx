...
function trimmingFormToInherited(values: TrimmingFormValues): InheritedRfq {
  ...
  return {
    ...
    ts_buhler_machine_ton: values.ts_buhler_machine_ton,
    ts_num_cavities_sets: values.ts_num_cavities_sets,
    ts_three_plate_mold: values.ts_three_plate_mold,
    ts_num_gates_per_part: values.ts_num_gates_per_part,
    ts_num_mech_slides: values.ts_num_mech_slides,
    ts_num_hydr_slides: values.ts_num_hydr_slides,
    ts_num_parts_per_stroke: values.ts_num_parts_per_stroke,
    ts_num_tools: values.ts_num_tools,
  };
}
